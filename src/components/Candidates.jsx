                            ...
                            {featuredCandidates.map((candidate) => (
                                ...
                                >
                                    <div className="candidate-card__avatar">
                                        {candidate.image ? <img src={candidate.image} alt={candidate.name} /> : <User size={40} />}
                                    </div>
                            ...
                            >
                                <div className="quochoi-card__header">
                                    <div className="quochoi-card__avatar">
                                        {candidate.image ? <img src={candidate.image} alt={candidate.name} /> : <User size={48} />}
                                    </div>
